...
| `client_overrides`  | optional                               | dict </br>This is the override parameter that allows user to specify which instantiation of the SDK to be overridden simply by adding `client_overrides[key]`.</br> Keys are allowed to be overridden are: </br>- app_id</br>- app_key</br>- base_url</br> - automatic_signing</br> |
