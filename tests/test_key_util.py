...
class TestKeyUtil(TestCase):
    ...
    def test_get_public_key_from_private_key(self):
        ...
        assert_equal(public_key, "idpub2TWHFrWrJxVEmbeXnMRWeKBdFp7bEByosS1phV1bH7NS99zHF9")
    ...
    def test_validate_signature(self):
        ...
        with assert_raises(Exception) as cm:
            KeyUtil.validate_signature("idpub2TWHFrWrJxVEmbeXnMRWeKBdFp7bEByosS1phV1bH7NS99zHF9", "D+lzNLb88IKXQk2BglvP7o6yK/DNAsO1B9qXdqArvrotTqSCI4Y4d8J8bwbfAyCvJT9tLYj9Ll7grCnyDWVtCg==", "")
            assert_true("message is required." in str(cm.exception))
